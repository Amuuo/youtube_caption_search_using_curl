...
struct WINRT_EBO SearchPage2_base : implements<D, Youtube_Caption_XAML_UI::ISearchPage2, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, composing, I...>,
...
{
    using base_type = SearchPage2_base;
    using class_type = Youtube_Caption_XAML_UI::SearchPage2;
    using implements_type = typename SearchPage2_base::implements_type;
    ...
    {
        return L"Youtube_Caption_XAML_UI.SearchPage2";
    }
    SearchPage2_base()
    {
...
struct WINRT_EBO SearchPage2T : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    hstring GetRuntimeClassName() const
    {
        return L"Youtube_Caption_XAML_UI.SearchPage2";
...
#if defined(WINRT_FORCE_INCLUDE_SEARCHPAGE2_XAML_G_H) || __has_include("SearchPage2.xaml.g.h")

#include "SearchPage2.xaml.g.h"
...
{
    template <typename D, typename... I>
    using SearchPage2T = SearchPage2_base<D, I...>;
}
